...
module.exports = function(args) {
  ...
  function activePieces(args) {
    ...
    if(armyData.king && !_.contains(armyData.takenPieces, armyData.king)) {
      pieces = pieces.concat([armyData.king]);
    }
    return pieces;
  }
  ...
  function pieceUnderAttack(args) {
    ...
    return _(armies).
      without(piece.army).
      any(function (army) {
        return _.any(activePieces({ army: army }), function(activePiece) {
